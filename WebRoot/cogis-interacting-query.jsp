...
"https://js.arcgis.com/4.3/" */
	...
	require([
		...
		resultsLayer.title = "resultsLayer";
			...
			view.hitTest(screenPoint)
				.then(function(response) {
					...
					if (graphic) {
						...
						//通过图层title识别当前选中图形
						if (graphic.layer.title == "resultsLayer") {
							//设置弹出面板标题
							graphic.popupTemplate.title = "缓冲区查询结果图层";
							
						} else if (graphic.layer.title == "HarperSumnerOGWells") {
